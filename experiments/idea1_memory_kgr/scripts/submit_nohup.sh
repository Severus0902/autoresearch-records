...
STAGE="${1:?Usage: bash scripts/submit_nohup.sh <stage0|stage1|stage2|stage3|stage4|stage5|stage6|stage7|stage8> [config] [extra args...]}"
...
case "$STAGE" in
  ...
  stage8) SCRIPT="scripts/stage8_eval_ranking_signal.py" ;;
